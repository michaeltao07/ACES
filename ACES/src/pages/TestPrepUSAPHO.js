...
import styles from "./TestPrepUSAPHO.module.css";

const TestPrepUSAPHO = () => {
  ...
  return (
    <>
      <div className={styles.testPrepusapho}>
        ...
        <div className={styles.whyUs}>
          ...
          <div className={styles.accordion}>
            ...
            <div className={styles.header}>
              <b className={styles.physicsCourses}>SAT/PSAT Courses</b>
        ...
        <div className={styles.mathOverview}>
          ...
          <div className={styles.ourTestPreparationContainer}>
            <p
              className={styles.p}
            >{`Our Test Preparation Program expands on our original SAT Summer Intensive workshop and focuses solely on preparing students for standardized college admissions tests such as the SAT and PSAT. `}</p>
            <ul className={styles.weNowOffer4WeekSatpsatW}>
              <li
                className={styles.weNowOffer}
              >{`We now offer 4-week SAT/PSAT workshops. `}</li>
              <li
                className={styles.weNowOffer}
              >{`The workshop will provides a balance between lecture concepts and strategies, actual timed practice, and interactive review in order to provide optimal results. `}</li>
            </ul>
            <p className={styles.p}>
              In ACES test preparation courses, your student get :
            </p>
            <ul className={styles.weNowOffer4WeekSatpsatW}>
              <li
                className={styles.weNowOffer}
              >{`immediate feedback on both multiple choice questions and essays `}</li>
              <li>
                as well as take part in an engaging and collaborative
                environment that allows them to see how students approach
                questions and decipher answers.
              </li>
            </ul>
          </div>
          <b className={styles.testPreparationEnrichment}>
            Test Preparation Enrichment - Overview
          </b>
        </div>
