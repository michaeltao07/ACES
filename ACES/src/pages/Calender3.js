import styles from "./Calender3.module.css";
  ...
  return (
    <div className={styles.calender}>
      ...
      <div className={styles.monday}>
        ...
        <b className={styles.b6}>9</b>
        <b className={styles.b7}>16</b>
        <b className={styles.b8}>23</b>
        <b className={styles.b9}>30</b>
        <b className={styles.b10}>3</b>
        <b className={styles.b11}>10</b>
        <b className={styles.b12}>17</b>
        <b className={styles.b13}>24</b>
        <b className={styles.b14}>1</b>
        <b className={styles.b15}>4</b>
        <b className={styles.b16}>11</b>
        <b className={styles.b17}>18</b>
        <b className={styles.b18}>25</b>
        <b className={styles.b19}>2</b>
        <b className={styles.b20}>5</b>
        <b className={styles.b21}>12</b>
        <b className={styles.b22}>19</b>
        <b className={styles.b23}>26</b>
        <b className={styles.b24}>3</b>
        <b className={styles.b25}>6</b>
        <b className={styles.b26}>13</b>
        <b className={styles.b27}>20</b>
        <b className={styles.b28}>27</b>
        <b className={styles.b29}>4</b>
      </div>
      <div className={styles.sunday}>
        ...
        <b className={styles.b30}>31</b>
        <b className={styles.b31}>7</b>
        <b className={styles.b32}>14</b>
        <b className={styles.b33}>21</b>
        <b className={styles.b34}>28</b>
      </div>
      <b className={styles.april}>April</b>
    </div>
  );
};
